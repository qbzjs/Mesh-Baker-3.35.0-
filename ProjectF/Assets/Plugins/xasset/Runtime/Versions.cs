...
namespace xasset
{
    ...
    public static class Versions
    {
        ...
        public static readonly Manifest ForegroundManifest = Manifest.LoadFromFile("ForegroundManifest");
        public static readonly Manifest BackgroundManifest = Manifest.LoadFromFile("BackgroundManifest");
        public static readonly Manifest InnerManifest = Manifest.LoadFromFile("InnerManifest");
        ...
        ///     本地版本号
        /// </summary>
        public static int VersionCode { get; private set; }

        /// <summary>
        ///     获取清单的版本号
        /// </summary>
        public static string ManifestVersion => VersionCode.ToString();
        ...
        /// <returns></returns>
        public static DownloadInfo GetDownloadInfo(string file, string hash, long size, bool fastVerify = false)
        {
        ...
        public static void UpdateTimestamp(BuildVersions versions)
        {
            if (Timestamp < versions.timestamp) Timestamp = versions.timestamp;
        }
        ...
        public static void LoadVersion(Manifest manifest)
        {
            ...
            {
                case "Manifest": Manifest.Copy(manifest); break;
                case "Inner": InnerManifest.Copy(manifest); break;
                case "Foreground": ForegroundManifest.Copy(manifest); break;
                case "Background": BackgroundManifest.Copy(manifest); break;
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static CheckUpdate CheckForUpdatesAsync(string url = null)
        {
            var operation = new CheckUpdate {url = url};
            operation.Start();
            return operation;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static GetDownloadSize GetDownloadSizeAsync(Manifest manifest)
        {
        ...
        /// <param name="highPriority">是否进入优先下载队列</param>
        /// <returns></returns>
        public static DownloadFiles DownloadAsync(DownloadInfo[] items, bool highPriority)
        {
            var download = new DownloadFiles(highPriority);
